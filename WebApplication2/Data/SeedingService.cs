...
namespace WebApplication2.Data
{
    public  static class DbSeeder
    {
        ...
        {
            using var _context = serviceProvider.GetRequiredService<WebApplication2Context>();
            _context.Database.Migrate();

            if (!_context.Department.Any() ||
                !_context.Seller.Any() ||
                !_context.SalesReecord.Any())
            {
                ...
                _context.SalesReecord.AddRange(
...
//    var context = scope.ServiceProvider.GetRequiredService<WebApplication2Context>();
//    //var roleManager = scope.ServiceProvider.GetRequiredService<RoleManager<IdentityRole>>();
//    //var userManager = scope.ServiceProvider.GetRequiredService<UserManager<IdentityUser>>();
//    var logger = scope.ServiceProvider.GetRequiredService<ILogger<SeedingService>>();


//    //Add roles
//    if (context.Department.Any() ||
//    context.Seller.Any() ||
//    context.SalesReecord.Any())
//    {
//        return; // DB has been seeded
//    }
